		...
		<section className="w-full h-auto px-4 py-6 md:py-12" id="mirror">
			{!showAvancedForm && (
				<div className="w-full h-auto max-w-6xl mx-auto ">
					<h3 className="text-3xl md:text-[48px] md:leading-[60px] font-semibold w-full md:w-1/2">Discover Yourself. Look Into The MIRROR</h3>
			...
			{showAvancedForm && (
				<div className="w-full h-auto max-w-6xl mx-auto ">
					<div className="w-full flex items-center justify-between">
						<h1 className="text-4xl md:text-[48px] md:leading-[60px] font-semibold w-full md:w-1/2">You & Self</h1>
					...
					<div className="flex flex-col md:flex-row gap-8 md:gap-16 mt-8 justify-start h-auto items-stretch">
						<article className="flex flex-col w-full md:w-1/2 h-auto">
							<h3 className="text-3xl font-medium">Your Personality</h3>

							<div className="w-full h-auto mt-4">
								<h4 className="w-full text-2xl mb-2 font-medium">Strengths</h4>
							...
							<div className="w-full h-auto mt-8">
								<h4 className="w-full text-2xl mb-2 font-medium">Weaknesses</h4>
